...
@class DWGCDAsyncReadPacket;
@class DWGCDAsyncWritePacket;
@class DWGCDAsyncSocketPreBuffer;
@protocol DWGCDAsyncSocketDelegate;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const DWGCDAsyncSocketException;
extern NSString *const DWGCDAsyncSocketErrorDomain;

extern NSString *const DWGCDAsyncSocketQueueName;
extern NSString *const DWGCDAsyncSocketThreadName;

extern NSString *const DWGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const DWGCDAsyncSocketUseCFStreamForTLS;
#endif
#define DWGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define DWGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define DWGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const DWGCDAsyncSocketSSLPeerID;
extern NSString *const DWGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const DWGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const DWGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const DWGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const DWGCDAsyncSocketSSLCipherSuites;
extern NSString *const DWGCDAsyncSocketSSLALPN;
#if !TARGET_OS_IPHONE
extern NSString *const DWGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define DWGCDAsyncSocketLoggingContext 65535


typedef NS_ERROR_ENUM(DWGCDAsyncSocketErrorDomain, DWGCDAsyncSocketError) {
	DWGCDAsyncSocketNoError = 0,           // Never used
	DWGCDAsyncSocketBadConfigError,        // Invalid configuration
	DWGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	DWGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	DWGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	DWGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	DWGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	DWGCDAsyncSocketClosedError,           // The remote peer closed the connection
	DWGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface DWGCDAsyncSocket : NSObject

/**
 * DWGCDAsyncSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, DWGCDAsyncSocket will automatically create it's own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<DWGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<DWGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

/**
 * Create DWGCDAsyncSocket from already connect BSD socket file descriptor
**/
...
+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<DWGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq error:(NSError **)error;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<DWGCDAsyncSocketDelegate> delegate;
...
- (void)getDelegate:(id<DWGCDAsyncSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<DWGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<DWGCDAsyncSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<DWGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * For accepting incoming connections, this means DWGCDAsyncSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 * 
 * For outgoing connections, this means DWGCDAsyncSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, DWGCDAsyncSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, DWGCDAsyncSocket will automatically use IPv6.
 ...
 * When a connection is accepted, a new instance of DWGCDAsyncSocket will be spawned to handle it,
 ...
 * 
 * Please note the recommended way of releasing a DWGCDAsyncSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a DWGCDAsyncSocketReadMaxedOutError.
 ...
 * This is due to the fact that DWGCDAsyncSocket does NOT copy the data. It simply retains it.
 ...
 * 
 * - DWGCDAsyncSocketManuallyEvaluateTrust
 ...
 *     So DWGCDAsyncSocket will invoke the delegate method socket:shouldTrustPeer: passing the SecTrustRef.
 *
 ...
 *
 * - DWGCDAsyncSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default DWGCDAsyncSocket will use the SecureTransport layer to perform encryption.
 ...
 *     
 *     However, if you absolutely must, you can instruct DWGCDAsyncSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, DWGCDAsyncSocket
 ...
 *     
 *     Thus all the other keys in the given dictionary will be ignored by DWGCDAsyncSocket,
 ...
 *
 * - DWGCDAsyncSocketSSLProtocolVersionMin
 * - DWGCDAsyncSocketSSLProtocolVersionMax
 ...
 * 
 * - DWGCDAsyncSocketSSLSessionOptionFalseStart
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionFalseStart.
 * 
 * - DWGCDAsyncSocketSSLSessionOptionSendOneByteRecord
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionSendOneByteRecord.
 * 
 * - DWGCDAsyncSocketSSLCipherSuites
 ...
 *
 * - DWGCDAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see DWGCDAsyncSocketManuallyEvaluateTrust).
 ...
 *     You MUST use DWGCDAsyncSocketSSLProtocolVersionMin & DWGCDAsyncSocketSSLProtocolVersionMin instead.
 ...
 * Example usage:
 * 
 * - (void)socket:(DWGCDAsyncSocket *)sock didConnectToHost:(NSString *)host port:(uint16_t)port
 * {
...
@protocol DWGCDAsyncSocketDelegate <NSObject>
@optional
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(DWGCDAsyncSocket *)sock;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(DWGCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;

/**
 * Called when a socket has completed reading the requested data into memory.
 * Not called if there is an error.
**/
- (void)socket:(DWGCDAsyncSocket *)sock didReadData:(NSData *)data withTag:(long)tag;
...
**/
- (void)socket:(DWGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;

/**
 * Called when a socket has completed writing the requested data. Not called if there is an error.
**/
- (void)socket:(DWGCDAsyncSocket *)sock didWriteDataWithTag:(long)tag;

/**
 * Called when a socket has written some data, but has not yet completed the entire write.
 * It may be used for things such as updating progress bars.
**/
- (void)socket:(DWGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(DWGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(DWGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(DWGCDAsyncSocket *)sock;
 ...
 * 
 * Note: If the DWGCDAsyncSocket instance is deallocated while it is still connected,
...
**/
- (void)socketDidDisconnect:(DWGCDAsyncSocket *)sock withError:(nullable NSError *)err;
...
**/
- (void)socket:(DWGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
