...
extern NSString *const DWGCDAsyncUdpSocketException;
extern NSString *const DWGCDAsyncUdpSocketErrorDomain;

extern NSString *const DWGCDAsyncUdpSocketQueueName;
extern NSString *const DWGCDAsyncUdpSocketThreadName;

typedef NS_ERROR_ENUM(DWGCDAsyncUdpSocketErrorDomain, DWGCDAsyncUdpSocketError) {
	DWGCDAsyncUdpSocketNoError = 0,          // Never used
	DWGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	DWGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	DWGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	DWGCDAsyncUdpSocketClosedError,          // The socket was closed
	DWGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class DWGCDAsyncUdpSocket;

@protocol DWGCDAsyncUdpSocketDelegate <NSObject>
@optional
...
**/
- (void)udpSocket:(DWGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(DWGCDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(DWGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(DWGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(DWGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(DWGCDAsyncUdpSocket *)sock withError:(NSError  * _Nullable)error;
 ...
 * Example:
 * 
 * DWGCDAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^DWGCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^DWGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface DWGCDAsyncUdpSocket : NSObject

/**
 * DWGCDAsyncUdpSocket uses the standard delegate paradigm,
...
- (instancetype)initWithDelegate:(nullable id<DWGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<DWGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

#pragma mark Configuration

- (nullable id<DWGCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id<DWGCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id<DWGCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id<DWGCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<DWGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<DWGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * This means DWGCDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, DWGCDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, DWGCDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, DWGCDAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that DWGCDAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about DWGCDAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(nullable DWGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable DWGCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * DWGCDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, DWGCDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about DWGCDAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable DWGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable DWGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The DWGCDAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally DWGCDAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
